...
import { User, Mail, Shield, Lightbulb, Info, Building2, Activity, UserPlus, Sparkles, ArrowRight, Loader2 } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium">Create a new account for a student, teacher, or administrator.</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <Card className="border-primary/10 shadow-xl shadow-primary/5 rounded-[2.5rem] overflow-hidden bg-card/50 backdrop-blur-sm">
                <CardHeader className="p-8 pb-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <CardTitle className="text-2xl font-black tracking-tight">User Profile</CardTitle>
                  </div>
                        ...
                        <FormItem className="space-y-3">
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              ...
                              <SelectContent className="rounded-2xl bg-white dark:bg-[#09090b] opacity-100 backdrop-blur-none border border-border/50 shadow-2xl">
                              <SelectItem value={UserStatus.ACTIVE} className="rounded-xl font-bold">Active</SelectItem>                              <SelectItem value={UserStatus.INACTIVE} className="rounded-xl font-bold">Inactive</SelectItem>
        ...
        >
          <Card className="border-primary/10 shadow-lg rounded-[2rem] overflow-hidden bg-card/50 backdrop-blur-sm">
            <CardHeader className="bg-primary/5 pb-6">
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="text-lg font-black tracking-tight">Role Permissions</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="p-6 space-y-6">
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <p className="font-black text-xs uppercase tracking-widest text-destructive">Administrators</p>
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <p className="font-black text-xs uppercase tracking-widest text-primary">Teachers</p>
                  <p className="text-sm text-muted-foreground font-medium leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <p className="font-black text-xs uppercase tracking-widest text-muted-foreground">Students</p>
                  <p className="text-sm text-muted-foreground font-medium leading-relaxed">
          ...
          <Alert className="rounded-[2rem] border-primary/10 bg-primary/5 p-6">
            ...
            <div className="ml-2">
              <AlertTitle className="font-black text-sm uppercase tracking-widest mb-2">Next Steps</AlertTitle>
              <AlertDescription className="text-sm text-muted-foreground font-medium leading-relaxed">
                Once created, the user will receive an automated invitation email to set their secure password and complete their profile.
              </AlertDescription>
            </div>
          </Alert>
        </motion.div>
