            ...
            {isTeacher
              ...
              : ["status", "participation", "remarks"].map((s) => (
                  <TableHead
                    ...
                    className="text-[10px] font-black uppercase tracking-widest py-6"
                  >
                    {t(`classes.attendance.table.${s}` as any)}
                  </TableHead>
                ))}
          </TableRow>
        </TableHeader>
              ...
              {isTeacher ? (
                <>
                  ...
                  <TableCell>
                    <Badge
                      variant="outline"
                      className="text-yellow-600 border-yellow-500/20 bg-yellow-500/5"
                    >
                      {group.late}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <Badge
                      variant="outline"
                      className="text-blue-600 border-blue-500/20 bg-blue-500/5"
                    >
                      {group.excused}
                    </Badge>
                  </TableCell>
                ...
                <>
                  <TableCell>
                    <Badge className="bg-primary/10 text-primary border-none">
                      {group.records?.[0]?.status}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center gap-2 font-black text-xs">
                      <Zap className="h-3 w-3 text-yellow-500" />
                      {group.records?.[0]?.participationScore}/10
                    </div>
                  </TableCell>
                  <TableCell>
