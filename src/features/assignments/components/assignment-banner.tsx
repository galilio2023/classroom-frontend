...
import { BrainCircuit, Users, Calendar, Clock, Sparkles, Activity, FlaskConical, LayoutDashboard, FileText } from "lucide-react";
        ...
        <div className="p-8 md:p-12 flex flex-col lg:flex-row lg:items-center justify-between gap-8 md:gap-10">
          ...
          <div className="flex flex-col gap-3 w-full lg:w-auto">
            ...
            {isStaff && assignment.hasPeerReview && (
                ...
                onClick={() => {
                    toast.promise(
                    fetch(`${SOCKET_URL.replace("/socket.io", "")}/api/assignments/${assignment.id}/assign-peer-reviews`, {
                        method: "POST",
                        headers: {
