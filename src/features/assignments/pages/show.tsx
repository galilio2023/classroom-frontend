  ...
  if (isLoading)
    return (
      <div className="flex flex-col items-center justify-center h-[85vh] gap-8">
        ...
        <p className="text-sm font-black uppercase tracking-[0.3em] text-primary/60">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="font-black text-[10px] uppercase tracking-widest">
                        {t("assignments.show.latePolicy")}
                      </p>
                      <p className="text-sm text-muted-foreground">
                        {t("assignments.show.lateDescription")}
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="font-black text-[10px] uppercase tracking-widest">
                        {t("assignments.show.academicIntegrity")}
                      </p>
                      <p className="text-sm text-muted-foreground">
          ...
          <Card className="rounded-[2.5rem] md:rounded-[3rem] overflow-hidden border-none shadow-2xl text-start">
            <CardHeader className="bg-primary/5 p-8 md:p-10 border-b border-primary/10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-xl md:text-2xl font-black uppercase tracking-widest">
                    {t("assignments.show.studentSubmissions")}
                  </CardTitle>
                  <CardDescription className="font-bold text-primary/60">
                    {t("assignments.show.submissionsDescription")}
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
