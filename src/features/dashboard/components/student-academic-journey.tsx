...
export const StudentAcademicJourney = ({
  gradeTrends,
  subjectMastery,
  attendanceSummary,
            ...
            <CardContent className="space-y-6 md:space-y-8">
              ...
              <div className="space-y-2">
                <h4 className="text-2xl md:text-3xl font-black tracking-tight">
                  {t("dashboard.student.welcomeJourney")}
                </h4>
                <p className="text-sm md:text-base text-muted-foreground/80 font-medium max-w-md mx-auto leading-relaxed">
                  {t("dashboard.student.welcomeJourneyDesc")}
                </p>
              </div>
              <Button
            ...
            <Card className="border-border/40 shadow-2xl bg-orange-500/[0.03] backdrop-blur-xl rounded-[2.5rem] md:rounded-[3rem] overflow-hidden border-2 border-dashed group">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      <CardTitle className="text-xl md:text-2xl font-black tracking-tight text-orange-700">
                        {t("dashboard.student.focusArea")}
                      </CardTitle>
                      <div className="flex items-center gap-2">
                        <Sparkles className="h-3 w-3 text-ai-primary opacity-40" />
                        <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">
                          {t("dashboard.student.aiRecommendation")}
                        </span>
                      </div>
                    </div>
                  </div>
                  <Badge
                    variant="secondary"
                    className="rounded-full px-3 py-1 font-black text-[9px] uppercase tracking-widest bg-orange-500/10 text-orange-600 border border-orange-500/20 shadow-sm"
                  >
              ...
              <CardContent className="p-8 md:p-10 pt-2 space-y-6">
                <p className="text-sm md:text-base font-medium text-orange-600/80 leading-relaxed italic">
                  {t("dashboard.student.strugglingWith", {
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <CardDescription className="font-medium text-muted-foreground/60 text-sm md:text-base">
                    {t("dashboard.student.gradeProgressDesc")}
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardHeader className="p-8 md:p-10 pb-2">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <CardDescription className="font-medium text-muted-foreground/60 text-sm md:text-base">
                    {t("dashboard.student.subjectMasteryDesc")}
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
