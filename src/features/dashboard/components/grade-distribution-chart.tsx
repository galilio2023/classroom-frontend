      ...
      <Card className="border-none shadow-2xl overflow-hidden bg-card/50 backdrop-blur-xl rounded-[2rem] group">
        ...
        <div className="px-8 pb-8 flex items-center justify-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Student Performance</span>
          </div>
          <div className="flex items-center gap-2">
            <Sparkles className="h-3 w-3 text-ai-primary opacity-40" />
            <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">AI Analyzed</span>
          </div>
        </div>
      </Card>
    </motion.div>
