...
export const TodaySchedule = ({ schedule, show }: TodayScheduleProps) => {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border border-border/80 dark:border-white/5 shadow-2xl bg-card/50 backdrop-blur-xl rounded-[1.5rem] md:rounded-4xl relative group">
        {/* Premium Background Effects */}
        <div className="absolute top-0 end-0 w-32 md:w-48 h-32 md:h-48 bg-primary/5 rounded-full blur-3xl -me-16 md:-me-24 -mt-16 md:-mt-24 pointer-events-none group-hover:bg-primary/10 transition-colors duration-700" />
        <div className="absolute bottom-0 start-0 w-24 md:w-32 h-24 md:h-32 bg-ai-primary/5 rounded-full blur-3xl -ms-12 md:-ms-16 -mb-12 md:-mb-16 pointer-events-none" />
          ...
          <AnimatePresence mode="popLayout">
            {schedule.length > 0 ? (
              ...
              <motion.div
                ...
                className="text-center py-10 md:py-16 border-none shadow-inner bg-muted/20 rounded-[1.5rem] md:rounded-4xl flex flex-col items-center gap-4 group/empty overflow-hidden relative"
              >
