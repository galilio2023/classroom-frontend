...
/**
 * 🛡️ PERFORMANCE FIX: Move intensive SVG animations to a sub-memoized component
 * This prevents the entire Hero from re-rendering the SVG paths when XP changes
 * but readiness score remains the same.
 */
const ReadinessProgress = memo(({ score }: { score: number }) => {
  return (
...
ReadinessProgress.displayName = "ReadinessProgress";

export const MissionControlHero = memo(
  ({
    name,
    currentXP,
    currentLevel,
          ...
          <CardContent className="p-8 md:p-12 lg:p-16 xl:p-20 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
              <div className="relative">
                <ReadinessProgress score={readinessScore} />
                <motion.div
...
MissionControlHero.displayName = "MissionControlHero";
