                  ...
                  >
                      ...
                      <CardContent className="p-8 pt-2 space-y-8 relative z-10">
                          <p className="text-sm text-muted-foreground font-medium leading-relaxed">
                              {t("dashboard.staff.promos.aiAssistant.description").split("Gemini 3 Flash Preview").map((part, i, arr) => (
                                <React.Fragment key={i}>
                                  {part}
                                  {i < arr.length - 1 && <span className="text-ai-primary font-black">Gemini 3 Flash Preview</span>}
                                </React.Fragment>
                              ))}                          </p>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            {[
                              ...
                              <div key={feat.label} className="flex items-center gap-2.5 p-3 rounded-xl bg-background/50 dark:bg-muted/30 border border-border/40 shadow-sm transition-colors group-hover:bg-background/80 dark:group-hover:bg-muted/50">
