...
export const XPCelebration = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-8 end-8 z-[10000] pointer-events-none flex flex-col gap-4 items-end">
        <AnimatePresence>
          {/* XP Gained Toast */}
          {activeXP && (
            <motion.div
            ...
            >
              <div className="p-3 rounded-2xl bg-primary/10 text-primary relative">
                ...
                <motion.div
                  ...
                  className="absolute -top-2 -end-2 bg-primary text-white text-[10px] font-black px-1.5 py-0.5 rounded-full shadow-lg"
                >
                  +{activeXP.amount}
                </motion.div>
              </div>
          ...
          {activeLevelUp && (
            ...
            >
              <div className="relative">
                ...
                <Sparkles className="absolute -top-4 -end-4 h-8 w-8 text-yellow-300 animate-spin-slow" />
              </div>
