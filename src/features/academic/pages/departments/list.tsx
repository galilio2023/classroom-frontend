...
import { useAcademicStats } from "../../hooks/use-academic-stats";
...
const DepartmentsList = () => {
  ...
  const { getDepartmentStats } = useAcademicStats();
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    estimateSize: () => 140, // Height of department card
    overscan: 5,
  });
  ...
  const handleConfirmDelete = useCallback(() => {
    if (deleteTarget) {
      deleteMutation(
        { resource: "departments", id: deleteTarget },
        {
          onSuccess: () => {
