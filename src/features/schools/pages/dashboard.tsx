...
const SchoolAdminDashboard = () => {
  ...
  const { query: auditQuery } = useCustom({
    url: `/schools/compliance-audit/${identity?.schoolId}`,
    method: "get",
    queryOptions: {
      enabled: !!identity?.schoolId,
    },
  ...
  const generateComplianceReport = () => {
    if (!audit) return "<p>Loading compliance data...</p>";

    return `
      <div style="font-family: sans-serif; border: 2px solid #4f46e5; padding: 25px; border-radius: 15px; background: white;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
          <h2 style="color: #4f46e5; text-transform: uppercase; margin: 0;">🛡️ Official Compliance Audit</h2>
          <span style="background: #10b981; color: white; padding: 4px 12px; border-radius: 20px; font-size: 10px; font-weight: bold;">LAW 151/2020</span>
        </div>
        
        <p><strong>Institution:</strong> ${identity?.schoolName}</p>
        <p><strong>Audit Date:</strong> ${new Date().toLocaleDateString()}</p>
        <p><strong>Compliance Score:</strong> ${audit.complianceScore}%</p>
        
        <hr style="border: 0; border-top: 1px solid #eee; margin: 20px 0;"/>
        
        <h3 style="color: #374151; font-size: 14px; text-transform: uppercase;">Control Verification</h3>
        ...
        <div style="margin-top: 30px; padding: 15px; background: #f9fafb; border-radius: 8px; font-size: 11px; color: #6b7280;">
          <strong>Cryptographic Proof:</strong><br/>
          <code style="word-break: break-all;">${audit.signature || "SHA256-PENDING-VERIFICATION"}</code>
        </div>
        
        <p style="font-size: 9px; color: #9ca3af; margin-top: 20px; text-align: center;">
          This document is an official record generated by Tablawy OS AI Governance Engine. 
          Ministerial Decision 816/2025 compliant.
        </p>
      </div>
    `;
  };
