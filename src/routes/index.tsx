...
const CreateAssignment = React.lazy(() => import("@/features/assignments/pages/create").then((m) => ({ default: m.AssignmentCreate })));
...
export const AppRouter = () => (
  <Suspense fallback={<Loading />}>
    <Routes>
      ...
      {/* PROTECTED ROUTES */}
      <Route element={<Authenticated key="authenticated-layout" fallback={<CatchAllNavigate to="/login" />}><SocketProvider><TermProvider><Outlet /></TermProvider></SocketProvider></Authenticated>}>
        <Route path="/pending-verification" element={<PendingVerification />} />
        <Route element={<VerificationGuard><Layout><Outlet /></Layout></VerificationGuard>}>
          <Route path="/dashboard" element={<AuthorizedRoute resource="dashboard" action="list"><Dashboard /></AuthorizedRoute>} />
          <Route path="/calendar" element={<AuthorizedRoute resource="calendar" action="list"><CalendarPage /></AuthorizedRoute>} />
          <Route path="/notifications" element={<AuthorizedRoute resource="notifications" action="list"><NotificationsPage /></AuthorizedRoute>} />
          <Route path="/messages" element={<AuthorizedRoute resource="messages" action="list"><MessagesPage /></AuthorizedRoute>} />
          
          <Route path="/project-groups">
            <Route index element={<AuthorizedRoute resource="project-groups" action="list"><ProjectGroupsPage /></AuthorizedRoute>} />
            <Route path="show/:id" element={<AuthorizedRoute resource="project-groups" action="show"><ShowProjectGroup /></AuthorizedRoute>} />
          </Route>

          <Route path="/library" element={<AuthorizedRoute resource="library" action="list"><GlobalLibraryPage /></AuthorizedRoute>} />

          {/* AI */}
          <Route path="/ai-assistant" element={<AuthorizedRoute resource="ai-assistant" action="list"><AiAssistantPage /></AuthorizedRoute>} />
          <Route path="/ai-study-lab" element={<AuthorizedRoute resource="ai-study-lab" action="list"><AiStudyLabPage /></AuthorizedRoute>} />
          <Route path="/ai-history">
            <Route index element={<AuthorizedRoute resource="ai-activity-logs" action="list"><AiHistoryList /></AuthorizedRoute>} />
            <Route path="show/:id" element={<AuthorizedRoute resource="ai-activity-logs" action="show"><AiHistoryShow /></AuthorizedRoute>} />
          </Route>
          ...
          {/* TEACHER HUB */}
          <Route path="/teacher/channel" element={<AuthorizedRoute resource="teacher-channel" action="list"><TeacherChannelPage /></AuthorizedRoute>} />
          <Route path="/teacher/subscriptions" element={<AuthorizedRoute resource="teacher-subscriptions" action="list"><TeacherSubscriptionsList /></AuthorizedRoute>} />

          {/* STUDENT HUB */}
          <Route path="/my-teachers" element={<AuthorizedRoute resource="my-teachers" action="list"><MyTeachersList /></AuthorizedRoute>} />
          <Route path="/discovery" element={<AuthorizedRoute resource="teacher-channels" action="list"><DiscoveryPage /></AuthorizedRoute>} />
          ...
          <Route path="/settings" element={<AuthorizedRoute resource="settings" action="edit"><SettingsEditPage /></AuthorizedRoute>} />
          <Route path="*" element={<ErrorComponent />} />
        </Route>
      </Route>

      {/* REDIRECT ROOT */}
      <Route element={<Authenticated key="authenticated-root-redirect" fallback={<Outlet />}><NavigateToResource resource="dashboard" /></Authenticated>}>
        <Route path="/" element={<LandingPage />} />
      </Route>

      <Route element={<Authenticated key="authenticated-outer" fallback={<Outlet />}><NavigateToResource resource="dashboard" /></Authenticated>}>
