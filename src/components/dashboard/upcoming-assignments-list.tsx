              ...
              return (
                <Card 
                  ...
                  className={cn(
                    ...
                    isUrgent ? "bg-destructive/5 border-destructive/20" : "hover:border-primary/30 bg-card/50 backdrop-blur-sm"
                  )}
                >
                  <div className="p-5 space-y-4">
                    ...
                    <Button 
                      className={cn(
                        ...
                        isUrgent ? "bg-destructive hover:bg-destructive/90 text-destructive-foreground" : "variant-outline hover:bg-primary hover:text-primary-foreground"
                      )}
