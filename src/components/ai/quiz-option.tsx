...
export const QuizOption: React.FC<QuizOptionProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center justify-between p-3 md:p-4 rounded-xl border-2 transition-all text-start text-sm md:text-base font-medium",
        !isAnswered && isSelected && "border-primary bg-primary/5 shadow-md",
        !isAnswered &&
          !isSelected &&
          "border-transparent bg-white dark:bg-white/5 hover:border-primary/30",
        isAnswered &&
          isCorrect &&
