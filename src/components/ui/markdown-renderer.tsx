    ...
    >
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ node, ...props }) => (
            <h1 className="text-2xl font-black mt-6 mb-4" {...props} />
          ),
          h2: ({ node, ...props }) => (
          ...
          ul: ({ node, ...props }) => (
            <ul className="list-disc ps-6 mb-4 space-y-2" {...props} />
          ),
          ol: ({ node, ...props }) => (
          ...
          img: ({ node, ...props }) => (
            <img
              className="rounded-xl border shadow-lg my-6 max-w-full h-auto"
              {...props}
            />
          ),
        }}
