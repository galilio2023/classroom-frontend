  ...
  "inline-flex items-center rounded-lg border px-3 py-1 text-[10px] sm:text-xs font-black uppercase tracking-widest transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground bg-background/50 backdrop-blur-sm border-border hover:bg-accent",
        ...
        ai: "bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 text-purple-600 dark:text-purple-400 border-purple-500/20",
      },
    },
    defaultVariants: {
      variant: "default",
