  ...
  ({ studentName, courseName, teacherName, date, completionId, className }, ref) => {
    ...
    return (
      <div 
        ...
        style={{ fontFamily: isArabic ? "'Cairo', sans-serif" : "'Times New Roman', serif" }}
      >
        {/* Decorative Border */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-6">
          ...
          <div className="space-y-8 w-full max-w-3xl">
            <p className="text-xl italic text-muted-foreground">{t("common.certificate.thisCertifies")}</p>
          ...
          <div className="flex justify-between items-end w-full max-w-3xl mt-12 px-12">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xs uppercase tracking-widest text-muted-foreground">{t("common.certificate.date")}</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-[10px] font-black text-white drop-shadow-md">{t("common.certificate.passed")}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xs uppercase tracking-widest text-muted-foreground">{t("common.certificate.instructor")}</p>
            </div>
          </div>
