  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-6 right-6 w-72 md:w-96 z-[9997] group overflow-hidden rounded-2xl md:rounded-[2rem] border border-white/20 shadow-2xl bg-black shadow-blue-500/20 backdrop-blur-xl"
      >
        {/* Video Container */}
        <div className="aspect-video relative overflow-hidden bg-black">
            ...
            <Button
                ...
                className="absolute top-2 right-2 h-8 w-8 rounded-full bg-black/40 hover:bg-black/60 text-white border border-white/10 z-20 opacity-0 group-hover:opacity-100 transition-opacity"
            >
                <X className="h-4 w-4" />
            </Button>
        </div>
