    ...
    <div
      className={cn(
        ...
        isOpen
          ...
          : "bottom-52 md:bottom-32 end-4 md:end-6"
      )}
    >
      {isOpen ? (
        <Card
...
export const AIStudyBuddy = (props: AIStudyBuddyProps) => {
  ...
  return (
    <AiFeatureGuard
      silent
      skeletonClassName="fixed bottom-52 md:bottom-32 end-4 md:end-6 h-14 w-14 md:h-16 md:w-16 rounded-3xl md:rounded-4xl"
    >
