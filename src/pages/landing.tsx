                ...
                <div className="grid grid-cols-12 gap-6 md:gap-8">
                    {pillars.map((pillar, idx) => (
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className={cn(
                                "p-10 rounded-[3rem] glass-card group flex flex-col relative overflow-hidden",
                                pillar.colSpan
                            )}
                        >
                            ...
                            <div className="mt-10 space-y-4 flex-1 text-start relative z-10">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        className="col-span-12 p-10 rounded-[3rem] bg-primary text-primary-foreground flex flex-col md:flex-row items-center gap-12 relative overflow-hidden group shadow-2xl shadow-primary/20"
                    >
                        ...
                        <div className="relative z-10 h-48 w-full md:w-96 bg-white/10 rounded-[2rem] border border-white/10 p-8 flex items-end gap-3 backdrop-blur-md">
                            ...
                            <motion.div initial={{ height: 0 }} whileInView={{ height: '100%' }} transition={{ delay: 0.8, duration: 1 }} className="flex-1 bg-white rounded-t-xl shadow-[0_0_30px_rgba(255,255,255,0.3)]" />
                        </div>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 items-stretch max-w-6xl mx-auto">
                    <Link to="/register" className="flex-1 group">
                        <motion.div 
                            ...
                            className="h-full p-12 md:p-20 rounded-[4rem] bg-card border border-border/40 transition-all duration-500 hover:shadow-3xl text-start relative overflow-hidden"
                        >
