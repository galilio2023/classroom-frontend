...
import { GraduationCap, BookOpen, Calculator, Calendar, Trophy, Star, TrendingUp, Award, FileText } from "lucide-react";
                                    ...
                                    <TableRow key={c.classId} className="group hover:bg-primary/2 transition-colors border-black/3 dark:border-white/3">
                                        <TableCell className="py-6 px-10">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-xs text-muted-foreground font-bold uppercase tracking-widest mt-0.5">{c.className}</span>
                                            </div>
                                        </TableCell>
                                        ...
                                        <TableCell className="text-center py-6">
                                            <div className="flex flex-col items-center gap-1">
                                                <span className="text-lg font-black tracking-tighter">{c.average}%</span>
                                                <div className="w-16 h-1.5 bg-muted rounded-full overflow-hidden">
                                                    <div 
                                                        className={cn(
                                                            "h-full rounded-full",
                                                            c.average >= 80 ? "bg-green-500" : c.average >= 60 ? "bg-primary" : "bg-destructive"
                                                        )}
                                        ...
                                        <TableCell className="text-end py-6 px-10">
                                            <div className={cn(
                                                ...
                                                c.letterGrade === "C" ? "bg-primary text-white shadow-primary/20" : 
