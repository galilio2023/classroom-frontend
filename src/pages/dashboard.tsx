...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Force a refetch when the component mounts or when identity/selectedTerm changes
    // This addresses issues where the dashboard might not load content after navigation without refresh
      ...
      >
        <div className="relative">
          ...
          <div className="absolute top-0 ltr:right-0 rtl:left-0 hidden md:flex items-center gap-3">
            <Badge
              variant="secondary"
              className="rounded-full px-4 py-1.5 font-black text-[10px] uppercase tracking-widest bg-card/50 backdrop-blur-xl border-black/[0.05] dark:border-white/[0.05] shadow-sm"
            >
            ...
            <Button
              variant="ghost"
              size="icon"
              className="rounded-full bg-card/50 backdrop-blur-xl border-black/[0.05] dark:border-white/[0.05] shadow-sm h-10 w-10"
            >
