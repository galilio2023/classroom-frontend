  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="z-10 space-y-6 max-w-lg">
        ...
        <h1 className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-destructive to-orange-500 tracking-tighter">
            403
        </h1>
        
        <h2 className="text-3xl font-black uppercase tracking-tight">{t("library.accessDenied")}</h2>
        ...
        <div className="pt-8">
            <Button asChild size="lg" className="h-14 px-8 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-105 transition-transform group">
                <Link to="/">
                    {isAr ? <ArrowLeft className="ml-2 h-5 w-5 rotate-180" /> : <ArrowLeft className="mr-2 h-5 w-5" />}
                    {t("buttons.goBack")}
                </Link>
            </Button>
        </div>
