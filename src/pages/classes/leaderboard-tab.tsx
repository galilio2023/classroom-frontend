              ...
              return (
                ...
                >
                  <Card className={cn(
                    ...
                    isFirst ? "bg-card/80 backdrop-blur-2xl md:scale-110 z-20 border-2 border-yellow-500/20" : "bg-card/40 backdrop-blur-xl z-10"
                  )}>
                    {isFirst && (
                    ...
                    <CardContent className="p-8 flex flex-col items-center text-center gap-6">
                      <div className="relative">
                        <div className={cn(
                          ...
                          isFirst ? "bg-yellow-500" : originalIndex === 1 ? "bg-slate-400" : "bg-amber-600"
                        )} />
                        <Avatar className={cn(
                          "h-24 w-24 border-4 relative z-10 transition-transform group-hover:scale-110 duration-500",
                          isFirst ? "border-yellow-500 shadow-2xl shadow-yellow-500/40" : 
                          originalIndex === 1 ? "border-slate-400 shadow-xl shadow-slate-400/20" : 
                          "border-amber-600 shadow-xl shadow-amber-600/20"
                        )}>
                          <AvatarImage src={student.image || ""} className="object-cover" />
                          <AvatarFallback className="text-2xl font-black bg-muted">{student.name[0]}</AvatarFallback>
                        </Avatar>
                        <motion.div 
                      ...
                      <div className="space-y-2 relative z-10">
                        ...
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <div className="flex items-center gap-1.5 text-gold-primary">
                            ...
                            <span className="text-lg font-black tracking-tight">{student.xp || 0} XP</span>
                          </div>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  return (
                    <motion.div 
                      ...
                      className={cn(
                        ...
                        isTopThree ? "bg-primary/5 border border-primary/10" : "hover:bg-muted/50 border border-transparent hover:border-black/[0.03] dark:hover:border-white/[0.03]"
                      )}
                    >
                      <div className="flex items-center gap-6">
                        <div className="w-10 flex justify-center items-center">
                          {isTopThree ? (
                            ...
                            <span className="text-sm font-black text-muted-foreground/40 group-hover:text-primary transition-colors">#{index + 1}</span>
                          )}
                        </div>
